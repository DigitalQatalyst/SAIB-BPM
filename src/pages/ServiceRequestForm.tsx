  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const newRequest = {
        ...
        selectedProcedureName: selectedProcedure || formState.title, // Store the selected procedure name
      };
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      <button
                        ...
                        className={`w-full text-left shadow-sm focus:ring-[#FECC0E] focus:border-[#FECC0E] block sm:text-sm border rounded-md h-12 px-4 bg-white hover:bg-gray-50 transition-colors flex items-center justify-between ${selectedProcedure ? 'border-[#FECC0E] bg-[#FECC0E]/5' : 'border-gray-300'
                          }`}
                      >
